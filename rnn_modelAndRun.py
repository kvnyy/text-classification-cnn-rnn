...
from rnn_model_tensorflow2_x import TRNNConfig, TextRNN
...
save_path = os.path.join(save_dir, 'best_validation2.keras')  # 最佳验证结果保存路径
...
if __name__ == '__main__':
    ...
    model2 = TextRNN(config)
    # 保存模型
    # model2.save("textrnn_model.keras")
    #
    # # 加载模型
